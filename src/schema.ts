...
/** WebAuthn passkey credentials. Each row is one registered authenticator
 *  (Touch ID, YubiKey, etc.) for a user. The plugin manages create / list /
 *  delete entirely on its own — we just provide the table. */
